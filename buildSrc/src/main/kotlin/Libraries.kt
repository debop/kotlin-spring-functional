...
object Versions {
    ...
    const val spring_boot = "2.2.0.M3"
    const val spring_fu = "0.2.BUILD-SNAPSHOT"
    const val spring_data_r2dbc = "1.0.0.M2"
    const val r2dbc = "Arabba-M8"
...
object Libraries {
    ...
    const val spring_fu_kofu = "org.springframework.fu:spring-fu-kofu:${Versions.spring_fu}"
    const val spring_data_r2dbc = "org.springframework.data:spring-dat-r2dbc:${Versions.spring_data_r2dbc}"

    const val r2dbc_h2 = "io.r2dbc:r2dbc-h2:${Versions.r2dbc}"
